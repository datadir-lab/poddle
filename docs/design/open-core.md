...
```
git.dev.datadir.co/datadir/poddle          public,  AGPL-3.0     (this repo)
git.dev.datadir.co/datadir/poddle-cloud     private, proprietary
```
...
- **MUST NOT** import core Go packages
  (`git.dev.datadir.co/datadir/poddle/src/internal/...` or `.../src/cli/...`).
