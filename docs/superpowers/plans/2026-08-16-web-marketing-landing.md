...
- Source/repo link everywhere: `https://git.dev.datadir.co/datadir/poddle` (Forgejo).
...
const repo = 'https://git.dev.datadir.co/datadir/poddle';
---
<header class="nav">
...
<footer class="footer">
  ...
  <div class="container footer__base">
    ...
    <a href={repo}>git.dev.datadir.co/datadir/poddle</a>
  </div>
</footer>
<style>
