...
import { cap1, rowKey } from "./aggregate";
...
// its own copy (the CLI dashboard says "start one with poddle up"). Rows are
// keyboard-operable (focus + Enter/Space drills down), matching a clickable
// table row's expected a11y behavior.
