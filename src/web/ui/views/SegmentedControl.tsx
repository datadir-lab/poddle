...
// colors the active segment by its meaning (e.g. block = deny-red); an
// option's `badge` renders a small count alongside its label (e.g. the audit
// filter's per-decision counts). Arrow-key navigation moves the roving
// tabindex and selection together, per the radiogroup a11y pattern.
